...
export const ExtensionErrors = {
  invalidCredentials: () => apiError('errors.api.auth.invalidCredentials', { status: 401 }),
  tooManyAttempts: () => apiError('errors.api.auth.tooManyAttempts', { status: 429 }),
  emailNotVerified: () => apiError('errors.api.auth.emailNotVerified', { status: 403 }),
  serviceUnavailable: () => apiError('errors.api.extension.serviceUnavailable', { status: 503 }),
  baseFileRequired: () => apiError('errors.api.extension.baseFileRequired'),
  offersRequired: () => apiError('errors.api.extension.offersRequired'),
  offerContentInsufficient: (index) => apiError('errors.api.extension.offerContentInsufficient', { params: { index } }),
  sourceCvNotFound: () => apiError('errors.api.extension.sourceCvNotFound', { status: 404 }),
  cancelParamsMissing: () => apiError('errors.api.extension.cancelParamsMissing'),
  taskNotFound: () => apiError('errors.api.extension.taskNotFound', { status: 404 }),
};
