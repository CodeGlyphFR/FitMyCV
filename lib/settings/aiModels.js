...
/**
 * Récupère le modèle pour l'amélioration d'expérience (CV Improvement)
 * @returns {Promise<string>} - Nom du modèle
 * @throws {Error} Si le setting n'existe pas
 */
...
/**
 * Récupère le modèle pour l'amélioration de projet (CV Improvement)
 * @returns {Promise<string>} - Nom du modèle
 * @throws {Error} Si le setting n'existe pas
 */
...
/**
 * Récupère le modèle pour l'amélioration du summary (CV Improvement)
 * @returns {Promise<string>} - Nom du modèle
 * @throws {Error} Si le setting n'existe pas
 */
...
/**
 * Récupère le modèle pour la classification des skills (CV Improvement)
 * @returns {Promise<string>} - Nom du modèle
 * @throws {Error} Si le setting n'existe pas
 */
...
/**
 * Récupère le modèle pour le preprocessing des suggestions (CV Improvement)
 * @returns {Promise<string>} - Nom du modèle
 * @throws {Error} Si le setting n'existe pas
 */
...
/**
 * Récupère le modèle pour l'optimisation des langues (CV Improvement)
 * @returns {Promise<string>} - Nom du modèle
 * @throws {Error} Si le setting n'existe pas
 */
...
/**
 * Récupère le modèle pour les extras (certifications, hobbies, etc.) (CV Improvement)
