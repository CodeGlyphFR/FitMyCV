 ...
 * - V2: applyExperienceModifications(), applyProjectModifications() - utilisé par improveCvJob.js
 *
...
// ============================================================================
// V1 API - Legacy, conservé pour compatibilité
// ============================================================================
...
// ============================================================================
// API compatible avec improveCvJob.js
// ============================================================================
 ...
 */
export function applyExperienceModifications(experience, modifications) {
 ...
 */
export function applyProjectModifications(project, modifications, isNew) {
  if (isNew) {
