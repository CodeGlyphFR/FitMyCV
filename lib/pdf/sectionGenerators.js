                ...
                <div class="experience-header-block${headerBreak}">
                  <div class="experience-header">
                    <div>
                      ...
                      ${exp.company ? `<div class="experience-company">${exp.company}${exp.department_or_client ? ` (${exp.department_or_client})` : ''}${exp.location ? `<span class="experience-location"> - ${formatLocation(exp.location)}</span>` : ''}${exp.url ? `<a href="${exp.url}" class="experience-link" target="_blank">${exp.url_label || exp.url}</a>` : ''}</div>` : ''}
                    </div>
            ...
            return `
              <div class="project-item${itemBreak}">
                <div class="project-header">
                  <div>
                    ${project.name ? `<div class="project-name">${project.name}${project.url ? ` <a href="${project.url}" class="project-link" target="_blank">${project.url_label || project.url}</a>` : ''}</div>` : ''}
