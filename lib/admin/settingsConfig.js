...
export const SETTING_LABELS = {
  ...
  // Modèles IA - Pipeline CV v2
  model_cv_classify: 'Classification (KEEP/REMOVE/MOVE)',
  model_cv_batch_experience: 'Batch Expériences',
  model_cv_batch_projects: 'Batch Projets',
  model_cv_batch_extras: 'Batch Extras',
  model_cv_batch_skills: 'Batch Compétences',
  model_cv_batch_summary: 'Batch Summary',

  // Modèles IA - Pipeline Amélioration CV v2
  model_improve_preprocess: 'Preprocessing Suggestions',
