...
export const EventTypes = {
  ...
  CV_GENERATION_V2_STARTED: 'CV_GENERATION_V2_STARTED',
  CV_GENERATION_V2_COMPLETED: 'CV_GENERATION_V2_COMPLETED',
  CV_GENERATION_V2_FAILED: 'CV_GENERATION_V2_FAILED',
 ...
 */
export async function trackCvGenerationV2Started({
  userId,
  deviceId,
  taskId,
  totalOffers,
  ...
  return trackEvent({
    type: EventTypes.CV_GENERATION_V2_STARTED,
    userId,
    deviceId,
    metadata: {
 ...
 */
export async function trackCvGenerationV2Completed({
  userId,
  deviceId,
  taskId,
  offerId,
  ...
  return trackEvent({
    type: EventTypes.CV_GENERATION_V2_COMPLETED,
    userId,
    deviceId,
    metadata: {
      featureName: 'cv_generation_v2',
 ...
 */
export async function trackCvGenerationV2Failed({
  userId,
  deviceId,
  taskId,
  offerId,
  ...
  return trackEvent({
    type: EventTypes.CV_GENERATION_V2_FAILED,
    userId,
    deviceId,
    metadata: {
      featureName: 'cv_generation_v2',
