/**
 * Pipeline V2 d'amélioration CV - 4 stages parallélisés
 *
 * Ce module contient la logique du pipeline V2 pour l'amélioration des CV.
...
import {
  applySummaryDiff,
  applyExperienceModificationsV2,
  applyProjectModificationsV2
  ...
  if (!preprocessResult.success || !preprocessResult.data) {
    ...
    for (const result of stage3Results) {
      ...
      if (result.type === 'experience') {
        const modified = applyExperienceModificationsV2(
        ...
        const modified = applyProjectModificationsV2(
        ...
        const newProject = applyProjectModificationsV2(null, result.data.modifications, true);
