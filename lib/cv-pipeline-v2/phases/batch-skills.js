...
export async function executeBatchSkills({
  ...
  try {
    ...
    const userPrompt = replaceVariables(userPromptTemplate, {
      ...
      experiencesSummary: summarizeExperiences(adaptedExperiences),
      projectsSummary: summarizeProjects(adaptedProjects),
      jobTitle: jobOfferInfo.jobTitle,
      requiredSkills: jobOfferInfo.requiredSkills,
      niceToHaveSkills: jobOfferInfo.niceToHaveSkills,
      requiredSoftSkills: jobOfferInfo.requiredSoftSkills,
      requiredMethodologies: jobOfferInfo.requiredMethodologies,
      targetLanguage,
    });
