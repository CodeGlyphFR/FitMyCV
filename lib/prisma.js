 ...
 * Prisma 7: connexion via driver adapter PostgreSQL (@prisma/adapter-pg)
 * lisant process.env.DATABASE_URL au runtime
 */
const adapter = new PrismaPg({ connectionString: process.env.DATABASE_URL });
const prisma = globalForPrisma.prisma ?? createExtendedClient(new PrismaClient({ adapter }));
