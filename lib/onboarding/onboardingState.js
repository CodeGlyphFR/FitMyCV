 ...
 * - currentStep: numéro de l'étape actuelle (0-8)
 ...
 * - modals: tracking des modaux vus/complétés (welcome, step1, step2, step6, step8, completion)
 ...
 * @param {Object} state - État actuel de l'onboarding
 * @param {number} stepNumber - Numéro du step complété (1-8)
 * @returns {Object} Nouvel état mis à jour
 */
export const markStepCompleted = (state, stepNumber) => {
  ...
  // Incrémenter currentStep (sauf si c'est le dernier step)
  const totalSteps = 8;
  const nextStep = stepNumber < totalSteps ? stepNumber + 1 : stepNumber;
 ...
 * @param {Object} state - État actuel de l'onboarding
 * @param {number} stepNumber - Nouveau step actuel (0-8)
 * @returns {Object} Nouvel état mis à jour
 */
