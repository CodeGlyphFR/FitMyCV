...
export const ONBOARDING_TIMINGS = {
  ...
  // Délai après fermeture modal avant action suivante
  MODAL_ANIMATION_DELAY: 300, // 0.3s - délai après fermeture modal avant action suivante
...
export const STEP_TO_MODAL_KEY = {
  ...
  8: 'step8', // Gestion des versions (2 écrans)
  9: 'step9', // Export PDF (2 écrans)
  // Steps 3, 4, 6 n'ont pas de modals
};
