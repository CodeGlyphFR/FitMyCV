...
export const ONBOARDING_TIMINGS = {
  ...
  STEP_TRANSITION_DELAY: 1000, // 1s - délai standard entre étapes (permet à l'utilisateur de voir les changements)
...
export const STEP_TO_MODAL_KEY = {
  ...
  1: 'step1', // Mode édition (5 écrans)
  2: 'step2', // Génération IA (3 écrans)
  6: 'step6', // Optimisation (3 écrans)
  8: 'step8', // Export PDF (3 écrans)
  // Steps 3, 4, 5, 7 n'ont pas de modals
};
