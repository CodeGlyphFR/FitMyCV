...
/**
 * Nombre total d'étapes (1-9, sans le welcome)
 */
export const ONBOARDING_STEPS_COUNT = 9;

/**
 * Définitions minimales des étapes principales (1-9)
...
export const STEP_DEFINITIONS = [
  ...
  { id: 5, key: 'ai_review', emoji: '🔍' },
  { id: 6, key: 'match_score', emoji: '🎯' },
  { id: 7, key: 'optimization', emoji: '🚀' },
  { id: 8, key: 'history', emoji: '🔄' },
  { id: 9, key: 'export', emoji: '📥' },
];
...
export const STEP_NAMES = {
  ...
  ai_review: { name: 'AI Review', nameFr: 'Review IA' },
  match_score: { name: 'Match Score', nameFr: 'Score de match' },
  optimization: { name: 'Optimization', nameFr: 'Optimisation' },
  history: { name: 'Version Management', nameFr: 'Gestion des versions' },
...
export const STEP_DESCRIPTIONS = {
  ...
  ai_review: 'Review des modifications IA',
  match_score: 'Calcul du score de correspondance',
  optimization: 'Optimisation ATS du CV',
  history: 'Gestion et restauration des versions',
 ...
 * @param {number} stepId - ID de l'étape (0-9)
