      ...
      modal: {
        ...
        screens: [
          ...
          // ÉCRAN 2/3
          {
            ...
            subtitle2: t('onboarding.steps.step2.modal.screen2.subtitle2'),
            analysisLevels: [
              {
                emoji: '⚡',
                title: t('onboarding.steps.step2.modal.screen2.analysisLevels.rapid.title'),
                description: t('onboarding.steps.step2.modal.screen2.analysisLevels.rapid.description'),
              },
              {
                emoji: '⚙️',
                title: t('onboarding.steps.step2.modal.screen2.analysisLevels.normal.title'),
                description: t('onboarding.steps.step2.modal.screen2.analysisLevels.normal.description'),
              },
              {
                emoji: '🔍',
                title: t('onboarding.steps.step2.modal.screen2.analysisLevels.deep.title'),
                description: t('onboarding.steps.step2.modal.screen2.analysisLevels.deep.description'),
              },
            ],
          },
          // ÉCRAN 3/3
