 ...
 */
export async function detectJobOfferLanguage(jobOffer, fallbackLanguage = 'fr') {
  ...
  if (textToAnalyze.length > 50) {
    try {
      const detectedCode = await detectLanguageFromText(textToAnalyze.substring(0, 500));
