...
import { getOpenAIClient, addTemperatureIfSupported, isReasoningModel, addReasoningEffortIfSupported } from '@/lib/openai-core/client';
import { getAiModelSetting } from '@/lib/settings/aiModels';
import { writeDebugLog, LogType } from '../../utils/debugLog.js';
...
export async function processCategoryBatch({
  ...
  try {
    ...
    // Ajouter max_completion_tokens uniquement pour les modèles de raisonnement (réduit de 16000 à 8000)
    ...
    await writeDebugLog({
      ...
      response: result,
      duration,
      title: `Debug Skills Batch: ${category}`,
    });
