...
/**
 * Identifie un utilisateur côté serveur dans PostHog
 * Associe des propriétés (nom, email) à un distinctId, indépendamment du client-side
 * @param {string} distinctId - Identifiant unique de l'utilisateur
 * @param {object} properties - Propriétés à associer (email, name, etc.)
 */
