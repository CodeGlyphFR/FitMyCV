...
export const FEATURE_CONFIG = {
  ...
  // === CV Improvement V2 - Sous-tâches ===
  cv_improvement_v2_preprocess: {
    name: 'Amélioration CV - Préparation',
    icon: '🔧',
    colors: {
      from: '#06B6D4',    // cyan-500
      to: '#0891B2',      // cyan-600
  ...
  classify_skills: {
    name: 'Classification compétences',
    icon: '🏷️',
    colors: {
      from: '#06B6D4',    // cyan-500
      to: '#0891B2',      // cyan-600
  ...
  cv_improvement_v2_experience: {
    name: 'Amélioration CV - Expériences',
    icon: '💼',
    colors: {
      from: '#06B6D4',    // cyan-500
      to: '#0891B2',      // cyan-600
  ...
  // === CV Adaptation V2 (Pipeline) - Sous-tâches ===
  cv_pipeline_v2_classify: {
    name: 'Adaptation CV - Classification',
    icon: '🏷️',
    colors: {
      from: '#3B82F6',    // blue-500
      to: '#2563EB',      // blue-600
  ...
  cv_pipeline_v2_batch_experience: {
    name: 'Adaptation CV - Expériences',
    icon: '💼',
    colors: {
      from: '#3B82F6',    // blue-500
      to: '#2563EB',      // blue-600
  ...
  cv_pipeline_v2_batch_project: {
    name: 'Adaptation CV - Projets',
    icon: '📁',
    colors: {
      from: '#3B82F6',    // blue-500
      to: '#2563EB',      // blue-600
  ...
  cv_pipeline_v2_batch_skills: {
    name: 'Adaptation CV - Compétences',
    icon: '⚙️',
    colors: {
      from: '#3B82F6',    // blue-500
      to: '#2563EB',      // blue-600
  ...
  cv_pipeline_v2_batch_extras: {
    name: 'Adaptation CV - Extras',
    icon: '➕',
    colors: {
      from: '#3B82F6',    // blue-500
      to: '#2563EB',      // blue-600
  ...
  cv_pipeline_v2_batch_summary: {
    name: 'Adaptation CV - Résumé',
    icon: '📝',
    colors: {
      from: '#3B82F6',    // blue-500
      to: '#2563EB',      // blue-600
  ...
  cv_pipeline_v2_recompose_languages: {
    name: 'Adaptation CV - Langues',
    icon: '🌍',
    colors: {
      from: '#3B82F6',    // blue-500
      to: '#2563EB',      // blue-600
