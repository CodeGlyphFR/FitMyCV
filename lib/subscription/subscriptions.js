...
export async function assignDefaultPlan(userId, stripeCustomerId = null) {
  try {
    ...
    if (!subscriptionEnabled) {
      ...
      console.log(`[Subscriptions] Mode crédits-only: attribution des crédits de bienvenue à user ${userId}`);
      ...
      if (!existingBalance) {
        ...
        console.log(`[Subscriptions] ${welcomeCredits} crédits de bienvenue attribués à user ${userId}`);
      }
