...
import { ensureUserCvDir, writeUserCvFile, deleteUserCvFile } from "@/lib/cv/storage";
...
export async function runImportPdfJob({
  ...
  try {
    ...
    console.log(`[importPdfJob] Langue détectée lors de l'extraction: ${detectedLanguage}`);
