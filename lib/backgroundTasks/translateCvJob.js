...
export async function runTranslateCvJob({
  ...
  try {
    ...
    // Définir la langue du CV traduit (pas de détection nécessaire, on connaît la cible)
    cvData.language = targetLanguage; // 'fr' ou 'en'
    console.log(`[translateCvJob] Langue définie: ${targetLanguage}`);
