 ...
 * - A title (mandatory)
 * - AND either responsibilities OR skills (to prove there's real content)
 *
...
export function isJobOfferValid(extraction) {
  ...
  // Must have either responsibilities OR skills (proves real job content)
  ...
  // Require title AND (responsibilities OR skills)
  return hasResponsibilities || hasSkills;
}
