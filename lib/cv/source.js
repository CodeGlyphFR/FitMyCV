 ...
 * @param {string|null} createdBy - Fonctionnalité qui a créé le CV: 'import-pdf', 'generate-cv', ou null pour manuel
 * @param {string|null} analysisLevel - Niveau d'analyse: 'rapid', 'medium', 'deep', ou null
 */
export async function setCvSource(userId, filename, sourceType, sourceValue, createdBy = null, analysisLevel = null) {
  if (!userId || !filename) {
