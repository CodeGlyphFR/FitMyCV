...
/**
 * Template email d'avertissement d'inactivité (30 jours avant suppression)
 */
export function getInactivityWarningEmailTemplate(params, variables) {
  const { userName, loginUrl, lastActivityDate, deletionDate } = variables;
  const displayName = userName || 'utilisateur';
  return `
    <!DOCTYPE html>
    <html>
    <head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Votre compte sera supprimé - FitMyCV.io</title>
    </head>
    <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; margin: 0; padding: 0; background-color: #f4f4f5;">
      <table role="presentation" style="width: 100%; border-collapse: collapse;">
        <tr>
            ...
            <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: white; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
              ...
              <tr>
                <td style="padding: 40px;">
                  ...
                  <p style="color: #374151; font-size: 16px; line-height: 1.6; margin: 0 0 20px;">
                    Nous avons remarqué que vous n'avez pas utilisé votre compte FitMyCV.io depuis le <strong>${lastActivityDate}</strong>.
                  </p>
                  <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 15px 20px; margin: 20px 0; border-radius: 0 8px 8px 0;">
                    <p style="color: #92400e; font-size: 14px; margin: 0;">
                      <strong>Important :</strong> Conformément à notre politique de confidentialité, votre compte et toutes vos données (CV, historique, paramètres) seront définitivement supprimés le <strong>${deletionDate}</strong>.
                    </p>
                  </div>
                  <p style="color: #374151; font-size: 16px; line-height: 1.6; margin: 0 0 30px;">
                    Pour conserver votre compte, il vous suffit de vous reconnecter avant cette date.
                  </p>
                  <div style="text-align: center; margin: 30px 0;">
                    <a href="${loginUrl}" style="display: inline-block; padding: 14px 32px; background: linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%); color: white; text-decoration: none; font-weight: 600; font-size: 16px; border-radius: 8px;">
                      Me reconnecter
                  ...
                  <p style="color: #6b7280; font-size: 14px; line-height: 1.6; margin: 20px 0 0; text-align: center;">
                    Si vous ne souhaitez plus utiliser FitMyCV.io, vous pouvez ignorer cet email.<br>
                    Votre compte sera automatiquement supprimé.
                  </p>
                </td>
              </tr>
              <tr>
