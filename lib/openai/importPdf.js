...
async function callChatGPT(client, model, cvSchema, pdfText, userId = null, analysisLevel = null) {
  try {
 ...
 */
export async function importPdfCv({ pdfFilePath, analysisLevel = 'medium', requestedModel = null, userId = null }) {
  ...
  const result = await callChatGPT(client, model, cvSchema, pdfText, userId, analysisLevel);
