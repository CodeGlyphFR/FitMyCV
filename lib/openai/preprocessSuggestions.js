...
export async function preprocessSuggestions({
  ...
  // Charger les prompts
  const systemPrompt = await loadPromptWithVars('lib/openai/prompts/improve-cv/preprocess-system.md', {});
  const userPrompt = await loadPromptWithVars('lib/openai/prompts/improve-cv/preprocess-user.md', {
