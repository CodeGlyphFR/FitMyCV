 ...
 * @returns {Promise<string>} - Language code ('fr' or 'en')
 */
  ...
  try {
    ...
    const requestOptions = addTemperatureIfSupported({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are a language detection assistant. Analyze the text and respond with ONLY "fr" for French or "en" for English. No other text.'
        },
        {
          role: 'user',
    ...
    const detectedLanguage = (content === 'en') ? 'en' : 'fr'; // Default to 'fr' if unclear
