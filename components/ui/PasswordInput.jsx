...
/**
 * Composant d'input pour mot de passe avec toggle de visibilité
 * @param {Object} props
 * @param {string} props.id - ID du champ
 * @param {string} props.name - Name du champ
 * @param {string} props.value - Valeur du champ
 * @param {Function} props.onChange - Handler onChange
 * @param {string} props.placeholder - Placeholder
 * @param {string} props.autoComplete - Attribut autoComplete
