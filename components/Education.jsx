              ...
              <div key={i} className="rounded-xl border border-white/15 p-3 relative z-0 overflow-visible">
                ...
                {editing && (
                  <div className="no-print absolute top-2 right-2 z-20 flex gap-2">
                    ...
                    <button onClick={() => setDelIndex(i)} className="text-[11px] rounded-lg border border-red-400/50 bg-red-500/30 backdrop-blur-sm px-2 py-0.5 text-white hover:bg-red-500/40 transition-all duration-200"><img src="/icons/delete.png" alt="Delete" className="h-3 w-3 " /></button>
                  </div>
                )}
