                  ...
                  <div className={`mt-1 w-4 h-4 rounded-full flex items-center justify-center ${importProgress > 20 ? 'bg-emerald-500' : 'bg-white/20'}`}>
                    {importProgress > 20 && (
                      <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1.8.8.010 1.414l-8 8a1.8.8.01-1.414 0l-4-4a1.8.8.011.414-1.414L8 12.586l7.293-7.293a1.8.8.011.414 0z" clipRule="evenodd" />
                      </svg>
                    )}
                  </div>
