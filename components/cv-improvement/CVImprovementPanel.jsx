    ...
    <>
      ...
      {isOpen && mounted && createPortal(
        ...
        >
          ...
          <div
            ref={modalRef}
            className="relative z-10 w-full max-w-4xl bg-[rgb(2,6,23)] rounded-xl border border-white/20 shadow-2xl overflow-hidden flex flex-col max-h-[calc(100dvh-2rem)] md:max-h-[calc(100dvh-4rem)]"
