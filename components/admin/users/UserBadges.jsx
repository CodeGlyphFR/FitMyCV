...
export function EmailStatusBadge({ emailVerified }) {
    ...
    return (
      <span className="px-2 py-1 text-xs bg-green-500/20 text-green-400 rounded flex items-center gap-1">
        <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1.8.5.00-1.414-1.414L9 10.586 7.707 9.293a1.8.5.00-1.414 1.414l2 2a1.8.5.001.414 0l4-4z" clipRule="evenodd" />
        </svg>
        Vérifié
      </span>
    );
  ...
  return (
    <span className="px-2 py-1 text-xs bg-orange-500/20 text-orange-400 rounded flex items-center gap-1">
      <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1.8.5.00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
      </svg>
      En attente
    </span>
  );
