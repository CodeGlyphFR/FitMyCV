...
export default function TopBar() {
  ...
  if (status === "loading") {
    return (
      <div
        className="no-print relative shrink-0 z-[10001] w-full bg-white/15 backdrop-blur-md ios-optimized-blur border-b border-white/20 min-h-[60px] backdrop-layer"
            ...
            <button
              ...
              className={`cv-selector-trigger w-full min-w-0 rounded-lg border backdrop-blur-sm px-3 py-1 text-sm flex items-center justify-between gap-3 overflow-hidden transition-all duration-500 text-white ${
                state.cvSelectorGlow
                  ? 'border-emerald-400 bg-emerald-500/40 shadow-[0_0_20px_rgba(52,211.6.4.0.6)] hover:bg-emerald-500/50'
