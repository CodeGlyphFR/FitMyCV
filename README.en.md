...
| **Backend** | Next.js API Routes, Prisma 7, PostgreSQL | 113 endpoints, 33 models |
...
| **Infra** | Docker (Node 24), GitHub Actions, Caddy, Cloudflare | Automated CI/CD, continuous deployment |
